...
<summary>' . $eachRow['artigoref'] . '</summary>';
    ...
    echo '<tr>
  <th style="width:30%; text-align:center;"><b>REFERÊNCIA DA PALETE</th>
  <th style="width:30%; text-align:center;"><b>DATA DE ENTRADA</th>
  <th style="width:30%; text-align:center;"><b>LOCALIZAÇÃO DA PALETE</th> 
</tr>';
    ...
    foreach ($sql2 as $eachRow2) {
        echo '<tr>';
        echo '<td style="width:30%; text-align:center;">' . $eachRow2['palref'] . '</td>
        <td style="width:30%; text-align:center;"> ' . $eachRow2['dataEntrada'] . '</td>
    <td style="width:30%; text-align:center;">' . $eachRow2['locref'] . ' </td>';
        echo '</tr>';
    }
