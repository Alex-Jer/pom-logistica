...
class myPDF extends FPDF
{
    function header()
    {
        ...
        $this->Cell(276, 5, iconv('UTF-8', 'windows-1252', 'GUIA DE RECEÇÃO'), 0, 0, 'C');
        $this->Ln();
