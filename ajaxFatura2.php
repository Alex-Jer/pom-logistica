    ...
    $clienteNome = $dado['nome'];
                        ...
                        if (isset($cliente)) {
                            ...
                            foreach ($query as $eachRow) {
                                ...
                                echo'
                                <tr>
                                    <td style="width:15%;">'.$NomeGuia.'</td>
                                    <td style="width:15%">'.$numReq.'</td>
                                    <td style="width:10%; text-indent:1.5rem">'.$numPaletes.'</td>
                                    <td style="width:20%; text-indent:3rem">'.$precoZona * $numPaletes * $diasArmazenamento . " €" .'</td>
                                    <td style="width:20%; text-indent:3rem">'.$CargaFinal . "€" .'</td>
                                    <td style="width:10%; text-indent:0.8rem">'.$diasArmazenamento.'</td>
                                    <td style="width:10%; text-indent:0.2rem">'.$Total . " €" .'</td>
                                </tr>';
